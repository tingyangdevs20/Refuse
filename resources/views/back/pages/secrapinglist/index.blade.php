...
@section('styles')
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
        integrity="sha512-o9b12nEp6qOBHnpd3b05NUOBtJ9osd/Jfnvs59GpTcf6bd3NUGw+XtfPpCUVHsWqvyd2uuOVxOwXaVRoO2s2KQ==" crossorigin="anonymous"
                                ...
                                <tbody>
                                    @foreach ($scrapingdata as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->country }} {{ $data->state }} {{ $data->city }}
                                                {{ $data->zip_code }}</td>
