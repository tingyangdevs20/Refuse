                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped table-bordered" id="datatable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-outline-primary btn-sm" title="Edit {{ $respond->keyword }}" data-keyword="{{ $respond->keyword }}" data-response="{{ $respond->response }}" data-id={{ $respond->id }} data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></button> -
                                                    <button class="btn btn-outline-danger btn-sm" title="Remove {{ $respond->keyword }}" data-id="{{ $respond->id }}" data-toggle="modal" data-target="#deleteModal"><i class="fas fa-times-circle"></i></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
