                            ...
                            <form action="{{ route('admin.account.update', $accounts) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per SMS Rate"
                                            name="sms_rate" id="sms_rate" value="{{ $accounts->sms_rate }}" step="0.00001"
                                            min="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per MMS Rate"
                                            name="mms_rate" id="mms_rate" value="{{ $accounts->mms_rate }}" step="0.00001"
                                            min="0" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per SMS Rate"
                                            name="email_rate" id="email_rate" value="{{ $accounts->email_rate }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per SMS Rate"
                                            name="rvm_rate" id="rvm_rate" value="{{ $accounts->rvm_rate }}" step="0.00001"
                                            min="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per Phone Cell Append Rate"
                                            name="phone_cell_append_rate" id="phone_cell_append_rate"
                                            value="{{ $accounts->phone_cell_append_rate }}" step="0.00001" min="0"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per Email Append Rate"
                                            name="email_append_rate" id="email_append_rate"
                                            value="{{ $accounts->email_append_rate }}" step="0.00001" min="0"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per Name Append Rate"
                                            name="name_append_rate" id="name_append_rate"
                                            value="{{ $accounts->name_append_rate }}" step="0.00001" min="0"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control"
                                            placeholder="Per Email Verification Rate" name="email_verification_rate"
                                            id="email_verification_rate" value="{{ $accounts->email_verification_rate }}"
                                            step="0.00001" min="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per Phone Scrub Rate"
                                            name="phone_scrub_rate" id="phone_scrub_rate"
                                            value="{{ $accounts->phone_scrub_rate }}" step="0.00001" min="0"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per Record Scraping Rate"
                                            name="scraping_charge_per_record" id="scraping_charge_per_record"
                                            value="{{ $accounts->scraping_charge_per_record }}" step="0.00001"
                                            min="0" required>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.settings.update', $settings) }}" method="post"
                                ...
                                <select hidden class="custom-select" name="auto_reply" required>
                                    ...
                                    <option value="0" {{ $settings->auto_reply ? '' : 'selected' }}>Not Active
                                    </option>
                                </select>
                                <!-- </div> -->
                                <!-- <div class="form-group"> -->
                                ...
                                <select hidden class="custom-select" name="auto_respond" required>
                                    <option value="1" {{ $settings->auto_responder ? 'selected' : '' }}>Active
                                    </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        <input type="text" class="form-control"
                                            placeholder="Enter new value to update" name="slybroad_call_url"
                                            name="slybroad_call_url" value="{{ $settings->slybroad_number }}" required>
                                    </div>
                                </div>
                                <div class="card-header bg-soft-dark ">
                                ...
                                <div class="form-group">
                                    @if (LaravelGmail::check())
                                        <a href="{{ route('gmail.logout') }}" class="btn btn-secondary">Logout From
                                            Gmail</a>
                                    @else
