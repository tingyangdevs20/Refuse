...
@section('content')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-soft-dark ">
                          ...
                          <span style="font-size: 14px;font-weight: bold;"> Chat Using Number: </span> <span style="margin-left:5px;color:#556ee6"> +18886418823</span>
 ...
 {{ $sms->client_number }} </span>    <span style="margin-left:50px"><i class="fa fa-envelope" aria-hidden="true"></i>
{{ $smsInfo->email1}}</span>
