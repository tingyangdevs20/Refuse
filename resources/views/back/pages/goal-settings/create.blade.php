                            ...
                            <form method="post" action="{{ route('admin.savegoals') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('country') is-invalid @enderror" id="goal" name="goal" placeholder="10000">
                                        @error('goal')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('money_per_month') is-invalid @enderror" id="money_per_month" name="money_per_month" placeholder="10000" step="any">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('gross_profit') is-invalid @enderror" id="gross_profit" name="gross_profit" placeholder="1000" step="any">
                                        @error('gross_profit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('contact_trun_into_lead') is-invalid @enderror" id="contact_trun_into_lead" step="any" name="contact_trun_into_lead" placeholder="10">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('leads_into_phone') is-invalid @enderror" id="leads_into_phone" step="any" name="leads_into_phone" placeholder="10">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('signed_agreements') is-invalid @enderror" id="signed_agreements" step="any" name="signed_agreements" step="any" placeholder="10%">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('escrow_closure') is-invalid @enderror" id="escrow_closure" step="any" name="escrow_closure" step="any" placeholder="80%">
