                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            style="width:100px" id="money_per_month" name="money_per_month"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            style="width:100px" id="gross_profit" name="gross_profit" placeholder="1000"
                                            step="any">
                                        @error('gross_profit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="contact_trun_into_lead">What percentage of the people you contact turn
                                            into leads? (a lead is a person at least open to the idea of selling their
                                            property…not a phone lead… just someone that said they might be open to selling)
                                            (if you don’t know, our user average is 1.5%)</label>
                                        <input type="number"
                                            class="form-control @error('contact_trun_into_lead') is-invalid @enderror"
                                            style="width:100px" id="contact_trun_into_lead" step="any"
                                            name="contact_trun_into_lead" placeholder="10">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="leads_into_phone">What percentage of your leads are you able to get on
                                            the phone? (if you don’t know, our user average is 50%)</label>
                                        <input type="number"
                                            class="form-control @error('leads_into_phone') is-invalid @enderror"
                                            style="width:100px" id="leads_into_phone" step="any" name="leads_into_phone"
                                            placeholder="10">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="signed_agreements">Of the people you talk to on the phone, what
                                            percentage will you get a signed contract from? (if you don’t know, our user
                                            average is 10%)</label>
                                        <input type="number"
                                            class="form-control @error('signed_agreements') is-invalid @enderror"
                                            style="width:100px" id="signed_agreements" step="any"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="escrow_closure">Of the signed contracts you get back, what percentage
                                            close escrow? (if you don’t know, our user average 80%)</label>
                                        <input type="number"
                                            class="form-control @error('escrow_closure') is-invalid @enderror"
                                            style="width:100px" id="escrow_closure" step="any" name="escrow_closure"
                                            step="any" placeholder="80%">
                                ...
                                <div class="col-md-6" style="display:none">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            style="width:100px" id="passed_inspection" step="any"
                                ...
                                <div class="col-md-6" style="display:none">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            style="width:100px" id="passed_title_search" step="any"
                                            name="passed_title_search" step="any" placeholder="">
                                ...
                                <div class="col-md-6" style="display:none">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            style="width:100px" id="deal_closed" step="any" name="deal_closed"
                                            step="any" placeholder="5">
                                        @error('deal_closed')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" style="display:none">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('attribute') is-invalid @enderror"
                                            id="attribute" style="width:100px" name="attribute">
