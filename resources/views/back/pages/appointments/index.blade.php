                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-soft-dark">
                            ...
                            <a href="{{ url('appointment', [encrypt(Auth::id())]) }}" target="_blank"style="margin-right: 5px" class="btn btn-outline-primary btn-sm float-right" title="appointments">Booking Link</a>
