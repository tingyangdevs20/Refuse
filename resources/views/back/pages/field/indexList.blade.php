                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-soft-dark ">
                            <i class="fas fa-edit mr-1"></i>Custom Fields
                                                ...
                                                @foreach ($customfields as $field)
                                                    <div id="rowCount{{ $count }}" class="col-lg-12">
                                                        ...
                                                        <input type="hidden" class="form-control" placeholder="Days"
                                                            value="{{ $field->id }}" name="field_list_id[]">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group mt-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="label[]" placeholder="Field Label"
                                                                        value="{{ $field->label }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-center">
                                                    <button type="button" class="btn btn-primary mt-2"
                                                        onclick="addNewRows(this.form);">Add New Custom Field</button>
                                                </div>
                                                <div class="col-md-3 text-center">
                                                </div>
                                            </div>
