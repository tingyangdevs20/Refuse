                ...
                <form action="{{ route('admin.template.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group pt-2">
                            ...
                            <select class="from-control" style="width: 100%;" id="type" name="type"
                                onchange="messageType(value)" required>
                        ...
                        <div class="show_email" style="display:none;">
                            <div class="form-group">
                                <label>Subject</label>
                                <input type="text" class="form-control email_body" name="subject"
                ...
                <form action="{{ route('admin.template.update', 'test') }}" method="post" id="editForm"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group pt-2">
                            <label>Message Type</label><br>
                            <select class="from-control" style="width: 100%;" id="type" name="type"
                                onchange="messageTypeEdit(value)" required>
                                <option value="">Select Type</option>
                                <option value="SMS">SMS</option>
                                <option value="MMS">MMS</option>
                                <option value="Email">Email</option>
                        ...
                        <div class="show_email_edit" style="display:none;">
                            <div class="form-group">
                                <label>Subject</label>
                                <input type="text" class="form-control email_body_edit" name="subject" id="subject"
                                    placeholder="Enter Subject">
                            </div>
                            <div class="form-group">
                                <label>Body</label>
                                <textarea class="form-control text12333 email_body_edit summernote-usage" name="email_body" id="body_email"
                                    rows="10"></textarea>
