...
@section('scripts')
    ...
    <script >
        ...
        function addNewRows(frm) {
            ...
            recRow += '</select></div>';
            recRow += '</div></div><div class="row show_sms_'+rowCount+'"><div class="col-md-12"><div class="form-group "><div id="count" class="float-lg-right"></div></div></div></div></div><div class="col-md-12"><div class="row"><div class="col-md-4 text-center"></div><div class="col-md-4 text-center"><hr></div><div class="col-md-4 text-center"></div></div></div></div></div>';
