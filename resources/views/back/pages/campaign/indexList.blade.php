                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group mt-3">
                                                                            ...
                                                                            <select class="custom-select category" onchange="show_alert(this)"  name="templat[]" required>
...
@section('scripts')
    ...
    <script >
        ...
        function addNewRows(frm) {
            ...
            recRow += '<div class="form-group mt-3" id="dvcategory"><label>Select Template</label><select onchange="show_alert('+this+')" class="custom-select category" name="templat[]"   required><option value="">Select Template</option>';
