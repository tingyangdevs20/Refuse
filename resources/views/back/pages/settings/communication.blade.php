                            ...
                            <div class="nav-tabs-wrapper">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item m-1">
                                        <a href="#AutoRespond" class="nav-link active" data-toggle="tab"> Auto Responder</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link" href="#AutoReply"
                                            data-toggle="tab">AutoReply</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link" href="#CallForward" data-toggle="tab">Call
                                            Forward Number</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link" href="#PhoneNumber" data-toggle="tab">Phone
                                            Number</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link"href="#markets"
                                            data-toggle="tab">Markets</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link"href="#Rvms" data-toggle="tab">RVMs</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link" href="#QuickResponse"
                                            data-toggle="tab">Quick
                                            Response</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link" href="#ProspectCampaign"
                                            data-toggle="tab">Prospect Campaigns</a>
                                    </li>
                                    <li class="nav-item m-1"><a class="nav-link" href="#LeadCampaign" data-toggle="tab">Lead
                                            Campaigns</a>
                                    </li>
                                </ul>
                            </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($campaigns as $campaign)
                                                            <tr>
                                                                ...
                                                                <td>{{ optional($campaign->group)->getContactsCount() }}
                                                                </td>
                                                                <td>
                                                                    <a
