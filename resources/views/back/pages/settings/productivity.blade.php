                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="tab-content clearfix">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-soft-dark ">
                                            ...
                                            <button id="add-task-button"
                                                class="btn btn-outline-primary btn-sm float-right ml-2" title="New"
                                        ...
                                        <div class="card-body">
                                            <div id="task-list-container">
                                                ...
                                                <form id="task-form" action="{{ route('admin.task-list.store') }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered" id="datatable">
                                                        <thead>
                                                            <tr>
                                                                <th width="8%"><input type="checkbox" id="selectAll"
                                                                        class="task-checkbox"></th>
                                                                <th>Task</th>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                            ...
                                                            @foreach ($tasks as $key => $task)
                                                                <tr data-task-id="{{ $task->id }}">
                                                                    ...
                                                                    <td><a href="{{ route('admin.task-list.show', $task->id) }}"
                                                                            id="trigger-startup-button">{{ @$task->tast }}
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <button
                                                                            class="btn btn-outline-primary btn-sm edit-task"
                                ...
                                <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('admin.task-list.store') }}" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" placeholder="Task List Name" name="task"
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button id="save-task-button" type="submit"
                                                        class="btn btn-primary">Save Task</button>
                                                    <button id="update-task-button" type="button"
                                ...
                                <div class="modal fade" id="editModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('admin.task-list.update', 'test') }}"
                                                method="post" id="editForm">
                                                @method('PUT')
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="edittask">Task List Name</label>
                                                        <input type="text" placeholder="Task List Name" name="task"
                                                            id="edittask" class="form-control">
                                                    </div>
                                ...
                                <div class="tab-pane" id="MarketingSpends">
                                    <div class="card">
                                        <div class="card-header bg-soft-dark ">
                                            ...
                                            <button class="btn btn-outline-primary btn-sm float-right ml-1" title="New"
                                                data-toggle="modal" data-target="#newModalMarketingSpend"><i
                                                    class="fas fa-plus-circle"></i></button>
                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-outline-primary btn-sm"
                                                                        ...
                                                                        data-daterange="{{ $record->daterange }}"
                                ...
                                <!-- TAB 2 CONTENT ENDS -->
                                {{-- Modal New --}}
                                <div class="modal fade" id="newModalMarketingSpend" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="date" required
                                                                placeholder="Select custom date range" name="daterange"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="number" required
                                                                placeholder="Enter Amount Spent" name="amount"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                {{-- Modal Edit --}}
                                <div class="modal fade" id="editModalMarketingSpend" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('admin.marketing-spend.update', 'test') }}"
                                                method="post" id="editForm">
                                                @method('PUT')
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Lead Source</label>
                                                        <select class="custom-select" name="lead_source" id="lead_source"
                                                            required>
                                                            <option value="">Lead Source</option>
                                                            <option value="Bandit Signs">Bandit Signs
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="date" required
                                                                ...
                                                                name="daterangeEdit" id="daterangeEdit"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                ...
                                {{-- End Modal Edit --}}
                                {{-- Modal Delete --}}
                                <div class="modal fade" id="deleteModalAutoRespond" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('admin.marketing-spend.destroy', 'test') }}"
                                                method="post" id="editForm">
                                                @method('DELETE')
                                                @csrf
                                                <div class="modal-body">
...
@section('scripts')
    ...
    <script>
        ...
        $('#editModal').on('show.bs.modal', function(event) {
            console.log('shown')
            var button = $(event.relatedTarget); // Button that triggered the modal
            var task = button.data('task-name');
            var id = button.data('id');

            var modal = $(this);

            modal.find('.modal-body #edittask').val(task);
            modal.find('.modal-body #id').val(id);
