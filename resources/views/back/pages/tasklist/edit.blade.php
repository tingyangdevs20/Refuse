                            ...
                            <form method="post" action="{{ route('admin.user.update', @$user->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="phone" class="form-control @error('email') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone',@$user->mobile) }}"  >
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('user_status') is-invalid @enderror" id="user_status" name="user_status">
                                        ...
                                        <option value="1" {{ old('user_status', $user->status) == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ old('user_status', $user->status) == 0 ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                    @error('user_status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
