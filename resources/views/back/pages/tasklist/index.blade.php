...
.inactive-status {
    background-color: rgb(245, 93, 93); /* Change to your desired color */
    border-radius: 5px; /* Adjust the radius as needed */
                                    ...
                                    <form id="task-form" action="{{ route('admin.task-list.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                @if(auth()->user()->can('administrator') || auth()->user()->can('user_task_create'))

                                                <button type="submit" class="btn btn-primary" id="add-task-button">Add Task</button>
                                                <button type="submit" class="btn btn-danger" id="delete-selected-button" style="display: none">Delete Task</button>
                                                @endif
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-outline-primary btn-sm edit-task" data-task-id="{{ @$task->id }}" data-task-name="{{ @$task->tast }}" data-assignee-id="{{ @$task->user->id }}" title="Edit Task"><i class="fas fa-edit"></i></button>
