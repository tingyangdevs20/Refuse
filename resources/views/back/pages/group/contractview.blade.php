            ...
            <!-- ============================================================== -->
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header bg-soft-dark ">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="float: right;"> Add Contract</button> 
                                   </div>
                                    <div class="card-body">
                                        <table class="table table-striped table-bordered" id="datatable">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $value->file }}</td>
                                                <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{ $value->id }}" style="float: right;"> Edit Contract</button> </td>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                      <form action="{{ route('admin.uploadcontractedit') }}"  method="POST" enctype="multipart/form-data">
                      @csrf
                      @method('POST')
                      <div class="form-group">
                        <input type="hidden" name="userid" value="{{ $value->id }}">
                                 <input type="text" class="form-control" style="width: 100%;" required id="optiontype" name="optiontype" value="{{ $value->type_contract }}" >
                                </div>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                                <!-- <select class="form-control" style="width: 100%;" required id="optiontype" name="optiontype">
                                    ...
                                    <input type="text" class="form-control" style="width: 100%;" required id="optiontype" name="optiontype" placeholder="Enter Contract Name" >
