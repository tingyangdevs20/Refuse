                    ...
                    <div class="col-12">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body p-5">
                                ...
                                @endif
                                <div class="col-md-7">
                                    <form action="{{ route('admin.group.contact.update', $contact->id) }}" class="" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="last_name" placeholder="Last Name"
                                                        id="last_name" class="form-control @error('last_name') is-invalid @enderror" value="{{ old('last_name', $contact->last_name ?? '') }}">
                                                    @error('last_name')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="street" placeholder="Property Address"
                                                        id="street" class="form-control" value="{{ old('street', $contact->street ?? '') }}">
                                                    @error('street')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Property State" name="state"
                                                        id="state" class="form-control" value="{{ old('state', $contact->state ?? '') }}">
                                                    @error('state')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" placeholder="Property City" name="city"
                                                        id="city" class="form-control" value="{{ old('city', $contact->city ?? '') }}">
                                                    @error('city')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Property Zip" name="zip"
                                                        id="zip" class="form-control" value="{{ old('zip', $contact->zip ?? '') }}">
                                                    @error('zip')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" name="number" placeholder="Primary Phone Number"
                                                        id="number" class="form-control" value="{{ old('number', $contact->number ?? '') }}">
                                                    @error('number')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Phone Number 2" name="number2"
                                                        id="number2" class="form-control" value="{{ old('number2', $contact->number2 ?? '') }}">
                                                    @error('number2')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" placeholder="Phone Number 3" name="number3"
                                                        id="number3" class="form-control" value="{{ old('number3', $contact->number3 ?? '') }}">
                                                    @error('number3')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="email" name="email1" placeholder="Email 1" id="email"
                                                        class="form-control" value="{{ old('email1', $contact->email1 ?? '') }}">
                                                    @error('email1')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="email" name="email2" placeholder="Email 2" id="email"
                                                        class="form-control" value="{{ old('email2', $contact->email2 ?? '') }}">
                                                    @error('email2')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
