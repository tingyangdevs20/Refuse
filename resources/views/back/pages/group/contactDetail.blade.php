                        ...
                        <div class="card-body">
                            ...
                            <form id="main_form" action="{{ route('admin.single-sms.store') }}" method="post"
                                ...
                                <div class="row">
                                                                    ...
                                                                    <div class="form-group" style="padding: 0 10px;">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="file" name="purchase_agreement"
                                                                                id="file" class="form-control" accept="application/pdf">
                                                                        </div>
                                                                        <button type="submit" id="agreement-upload-button"
                                                                            class="btn btn-primary">Move Lead to Deals</button>
                                    ...
                                    <div class="col-md-4" style="margin-top:-527px;margin-left:1200px">
                                        <div class="card content-div">
                                            <div class="form-group" style="padding: 0 10px;">
