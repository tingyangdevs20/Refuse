                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group" style="padding: 0 10px;">
                                                                                    ...
                                                                                    <div class="input-group mb-2" >
                                                                                        ...
                                                                                        <a id="button-call" class=" m-1" href="javascript:void(0)" phone-number="{{ $leadinfo->owner1_number2 == '' ? '' : $leadinfo->owner1_number2 }}"><i class="fas fa-phone whatsapp-icon" style="padding: 24%"></i></a>
                                                                                        <button id="button-hangup-outgoing" class='d-none'>
                                                                                            <i class="fas fa-phone whatsapp-icon hangupicon" style="padding: 24%"></i>
                                                                                        </button>
                                                                                        @endif
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group" style="padding: 0 10px;">
                                                                                    ...
                                                                                    <div class="input-group mb-2" >
                                                                                        ...
                                                                                        <a id="button-call" class="m-1" href="javascript:void(0)" phone-number="{{ $leadinfo->owner1_number3 == '' ? '' : $leadinfo->owner1_number3 }}"><i class="fas fa-phone whatsapp-icon" style="padding: 24%"></i></a>
                                                                                        <button id="button-hangup-outgoing" class='d-none'>
                                                                                            <i class="fas fa-phone whatsapp-icon hangupicon" style="padding: 24%"></i>
                                                                                        </button>
                                                                                        @endif
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group" style="padding: 0 10px;">
                                                                                    ...
                                                                                    <div class="input-group mb-2" >
                                                                                        ...
                                                                                        <a id="button-call" class="outgoing-call m-1" href="javascript:void(0)" phone-number="{{ $leadinfo->owner2_primary_number == '' ? '' : $leadinfo->owner2_primary_number }}"><i class="fas fa-phone whatsapp-icon" style="padding: 24%"></i></a>
                                                                                        <button id="button-hangup-outgoing" class='d-none'>
                                                                                            <i class="fas fa-phone whatsapp-icon hangupicon" style="padding: 24%"></i>
                                                                                        </button>
                                                                                        @endif
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group" style="padding: 0 10px;">
                                                                                    ...
                                                                                    <div class="input-group mb-2" >
                                                                                        ...
                                                                                        <a id="button-call" class="outgoing-call m-1" href="javascript:void(0)" phone-number="{{ $leadinfo->owner2_number2 == '' ? '' : $leadinfo->owner2_number2 }}"><i class="fas fa-phone whatsapp-icon" style="padding: 24%"></i></a>
                                                                                        <button id="button-hangup-outgoing" class='d-none'>
                                                                                            <i class="fas fa-phone whatsapp-icon hangupicon" style="padding: 24%"></i>
                                                                                        </button>
                                                                                        @endif
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group" style="padding: 0 10px;">
                                                                                    ...
                                                                                    <div class="input-group mb-2" >
                                                                                        ...
                                                                                        <a id="button-call" class="outgoing-call m-1" href="javascript:void(0)" phone-number="{{ $leadinfo->owner2_number3 == '' ? '' : $leadinfo->owner2_number3 }}"><i class="fas fa-phone whatsapp-icon" style="padding: 24%"></i></a>
                                                                                        <button id="button-hangup-outgoing" class='d-none'>
                                                                                            <i class="fas fa-phone whatsapp-icon hangupicon" style="padding: 24%"></i>
                                                                                        </button>
                                                                                        @endif
