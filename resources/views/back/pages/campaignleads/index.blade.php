                        ...
                        <div class="card-body">
                            ...
                            @else
                                ...
                                @foreach ($campaigns as $campaign)
                                    <tr>
                                        <td><a href="{{ route('admin.compaignlead.list',$campaign->id) }}">{{ $campaign->name }}</a></td>
                                        <!--<td>{{ $campaign->type }}</td>-->
                                        <!--<td>{{ $campaign->send_after_days }}</td>-->
                                        <!--<td>{{ $campaign->send_after_hours }}</td>-->
                                        <td>{{ optional($campaign->group)->name ?? "N/A" }}</td>
                                        <td>
                                            <a href="{{ route('admin.compaignlead.copy', $campaign->id) }}"><button data-toggle="modal" class="btn btn-outline-warning" >Copy</button></a>
                                            ...
                                            <form action="{{ route('admin.leadcampaign.destroy', $campaign->id) }}" method="POST" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
