                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped table-bordered" id="datatable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                     <a href="<?php echo e(route('admin.sms.show',$sms)); ?>" class="btn btn-outline-warning btn-sm" title="Reply" >View Replies</a> -
                                                    <button data-toggle="modal" data-target="#saveModal" class="btn btn-outline-success btn-sm" title="Change Lead Category" data-id="<?php echo e($sms->id); ?>" data-number="<?php echo e($sms->client_number); ?>" >Change Lead Category</button> -
                                                    <button data-toggle="modal" data-target="#deleteModal" class="btn btn-outline-danger btn-sm" title="Delete" data-id="<?php echo e($sms->id); ?>" >Delete</button>
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('admin.reply.destroy','test')); ?>" method="post" id="editForm">
...
<?php echo $__env->make('back.inc.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/bbagnall/public_html/bulk/test/bulk_sms/resources/views/back/pages/sms/reply/index.blade.php ENDPATH**/ ?>