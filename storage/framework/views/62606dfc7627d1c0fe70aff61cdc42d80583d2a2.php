                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                ...
                                <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('admin.campaign.list',$campaign->id)); ?>"><?php echo e($campaign->name); ?></a></td>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.compaign.copy', $campaign->id)); ?>"><button data-toggle="modal" class="btn btn-outline-warning" >Copy</button></a>
                                            ...
                                            <form action="<?php echo e(route('admin.campaigns.destroy', $campaign->id)); ?>" method="POST" style="display: inline-block;">
                                                <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Add the form for editing the campaign here -->
                        <form action="<?php echo e(route('admin.campaigns.update', $campaign->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="form-group">
                            <label for="name">Campaign Name</label>
...
<?php echo $__env->make('back.inc.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/bbagnall/public_html/bulk/test/bulk_sms/resources/views/back/pages/campaign/index.blade.php ENDPATH**/ ?>