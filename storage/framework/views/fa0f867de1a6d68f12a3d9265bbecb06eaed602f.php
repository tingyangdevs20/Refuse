...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('back/assets/css/mark-your-calendar.css')); ?>">
...
<body style="font-family: sans-serif;">
  <!-- <div class="main"> -->
    ...
    <div class="left appointments-sec">
        <?php if($getUserAppointments): ?>
          <?php $__currentLoopData = $getUserAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userAppointments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="appt-card">
                <div class="appt-card-body">
                  
                  <!-- setting id of appointment -->
                  <input type="hidden" class="appt_id" name="appt_id" value="<?php echo e($userAppointments->id); ?>">
                  <input type="hidden" class="previous_date" name="previous_date" value="<?php echo e(date('Y-m-d', strtotime($userAppointments->appt_date))); ?>">
                  <input type="hidden" class="previous_time" name="previous_time" value="<?php echo e(date('H:i', strtotime($userAppointments->appt_time))); ?>">


                  <!-- <h4 class="appt-u-title"><b>Name: </b> <?php echo e($userAppointments->name); ?></h4>
                  <p class="appt-u-email"><b>Email: </b><?php echo e($userAppointments->email); ?></p>
                  <p class="appt-u-mobile"><b>Phone: </b><?php echo e($userAppointments->mobile); ?></p> -->
                  <p class="appt-u-datetime"><b class="c-inner-text">When: </b><?php echo e(date('M j Y', strtotime($userAppointments->appt_date))); ?>, <?php echo e(date('H:i', strtotime($userAppointments->appt_time))); ?> (<?php echo e($userAppointments->timezone); ?>)</p>
                  <p class="appt-u-description"><b class="c-inner-text">Purpose: </b><?php echo e($userAppointments->description); ?></p>
    ...
    <div class="center">
      ...
      <form class="book_appointment" method="POST" action="<?php echo e(route('appointments.store')); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div  class="form-group">
            ...
            <input type="hidden" class="appt_date" name="appt_date" value="<?php echo e(old('appt_date')); ?>" required>
            <input type="hidden" class="appt_time" name="appt_time" value="<?php echo e(old('appt_time')); ?>" required>
            <div class="calendar-div">
            
              <?php $__errorArgs = ['appt_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="tel"  class="input mobile" placeholder="Mobile"
                name="mobile" id="mobile" value="<?php echo e(old('mobile')); ?>" minlength="10" maxlength="10" required>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <textarea type="text"  class="input description" style="height:100px" placeholder="What do you hope to get out of this call?"
                name="description" id="description" required><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
  ...
  <script src="<?php echo e(asset('back/assets/js/pages/timezones.full.js')); ?>"></script>
  <script src="<?php echo e(asset('back/assets/js/pages/mark-your-calendar.js')); ?>"></script>
  ...
  <script>
    $(document).ready(function() {
      ...
      var Slots = <?php echo $bookedSlots; ?>; //directly output the value of $bookedSlots
      ...
      $( ".cancel_appt_modal" ).dialog({
        ...
        buttons: {
          "Yes": function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('appointments.cancelAppointment')); ?>",
                data: {id: appt_id},
                dataType: "json",
        ...
        $( ".reschedule_appt_modal" ).dialog({
          ...
          buttons: {
            "Update": function() {
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(route('appointments.reschduleAppointment')); ?>",
                  data: {
                    id: appt_id,
...
</html><?php /**PATH /home4/bbagnall/public_html/bulk/test/bulk_sms/resources/views/book-appointment.blade.php ENDPATH**/ ?>