                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-bordered" id="datatable">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(route('admin.group.show',$group->id)); ?>">View Contacts (<?php echo e($group->getContactsCount()); ?>) </a></td>
                                            <td><?php echo e($group->getMessageSentCount()); ?>/<?php echo e($group->getContactsCount()); ?></td>


                                            <td><?php echo e($group->getVerifiedSentCount()); ?>/<?php echo e($group->getContactsCount()); ?></td>
                                            <td><?php echo e($group->getMailSentCount()); ?>/<?php echo e($group->getContactsCount()); ?></td>
                                            <td>%(<?php echo e($groupCounts->where('group_name', $group->name)->first()['contact_count']); ?>)</td>
                                            <td><?php echo e($group->created_at->format('j F Y')); ?></td>
                                            <td><?php echo e(@$group->skip_trace_optiontype); ?></td>
                                            <td>
        ...
        $(document).ready(function() {
            ...
            const csrfToken = $('meta[name="csrf-token"]').attr('content');
             ...
             $('.skip_trace_option').on('change', function () {
                ...
                $.ajax({
                    method: 'POST',
                    url: '<?php echo e(route('admin.skip-trace')); ?>',
                    data: {
