                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered" id="datatable">
                                ...
                                <?php $__currentLoopData = $scripts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $script): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($sr++); ?></td>
                                        <td><?php echo e($script->name); ?></td>
                                        <td>
                                            <?php echo htmlspecialchars_decode(stripslashes($script->scripts)); ?>
                                            <!--<?php echo e($script->body); ?>-->
                                        </td>
                                        <td>
                                            <button class="btn btn-outline-primary btn-sm edit-Script" title="Edit <?php echo e($script->name); ?>" data-name="<?php echo e($script->name); ?>" data-body="<?php echo e(htmlspecialchars_decode(stripslashes($script->scripts))); ?>" data-id="<?php echo e($script->id); ?>"  data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></button>
                                            -
                                            <button class="btn btn-outline-danger btn-sm" title="Remove <?php echo e($script->name); ?>" data-id="<?php echo e($script->id); ?>" data-toggle="modal" data-target="#deleteModal"><i class="fas fa-times-circle"></i></button>
                                        </td>
                                    </tr>
    ...
    <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.script.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.script.update','test')); ?>" method="post" id="editForm" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.script.destroy','test')); ?>" method="post" id="editForm">
...
<?php echo $__env->make('back.inc.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/bbagnall/public_html/bulk/test/bulk_sms/resources/views/back/pages/script/index.blade.php ENDPATH**/ ?>