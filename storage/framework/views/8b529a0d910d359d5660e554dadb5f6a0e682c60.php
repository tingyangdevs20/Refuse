                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered" id="datatable">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $rvms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rvm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($sr++); ?></td>
                                        <td><?php echo e($rvm->name); ?></td>
                                        <td><?php echo e($rvm->mediaUrl); ?></td>
                                        <td>
                                            <button class="btn btn-outline-primary btn-sm" title="Edit <?php echo e($rvm->name); ?>" data-id="<?php echo e($rvm->id); ?>" data-rvmname="<?php echo e($rvm->name); ?>" data-toggle="modal" data-target="#editModal"><i class="fas fa-edit"></i></button>
                                            <?php if($rvm->id>1): ?>
                                            -
                                            <button class="btn btn-outline-danger btn-sm" title="Remove <?php echo e($rvm->name); ?>" data-rvmid="<?php echo e($rvm->id); ?>" data-toggle="modal" data-target="#deleteModal"><i class="fas fa-times-circle"></i></button>
                                                <?php endif; ?>
                                        </td>
                                    </tr>
    ...
    <div class="modal fade" id="newModal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.rvm.store')); ?>" method="POST" enctype="multipart/form-data" />
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.rvm.update','test')); ?>" method="post" id="editForm" enctype="multipart/form-data" >
                    <?php echo method_field('PUT'); ?>
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.rvm.destroy','test')); ?>" method="post" id="editForm">
...
<?php echo $__env->make('back.inc.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/bbagnall/public_html/bulk/test/bulk_sms/resources/views/back/pages/rvm/index.blade.php ENDPATH**/ ?>