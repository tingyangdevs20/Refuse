...
class UserAgreementSendMail extends Mailable
{
    ...
    {
        $userAgreement = UserAgreement::select("user_agreements.id", "user_agreements.studio_id", "agencies.name as agency_name", "user_agreements.studio_id", "user_agreements.is_sign", "users.name as user_name", "users.email")
