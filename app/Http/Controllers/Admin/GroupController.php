                            ...
                            foreach ($importData as $headerIndex => $value) {
                                ...
                                if (isset($columnToHeader[$headerIndex])) {
                                    ...
                                    if ($headerIndex == $header_index) {
                                        // Check if the column is "number," "number2," or "number3"
                                        if ($column == "number" || $column == "number2" || $column == "number3") {
                                            // Increment the value by 1 before storing
                                            $insertData[$column] = '+1' . $value;
                                        } else {
